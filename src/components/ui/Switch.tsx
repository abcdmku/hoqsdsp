...
>(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    ...
    className={cn(
      [
        ...
        'data-[state=checked]:bg-dsp-accent data-[state=unchecked]:bg-dsp-primary/70',
      ].join(' '),
      className
    )}
    {...props}
  >
    <SwitchPrimitive.Thumb
      className={cn(
        'pointer-events-none block h-5 w-5 rounded-full bg-dsp-text shadow-sm ring-0 transition-transform',
