...
interface MetadataParams {
  commitModel: (next: { uiMetadata?: Partial<{ channelColors: Record<string, string>; channelNames: Record<string, string>; mirrorGroups: SignalFlowMirrorGroups; firPhaseCorrection: Record<string, FirPhaseCorrectionUiSettingsV1>; }> }, options?: { debounce?: boolean }) => void;
